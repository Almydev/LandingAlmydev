...
const translations = {
  es: {
    ...
    areasDesc: ['Automatización de procesos de nómina, selección y gestión del talento', 'Optimización de flujos operativos y supervisión en tiempo real', 'Control de stock, trazabilidad y reposición inteligente', 'Gestión de proveedores, órdenes de compra y presupuestos', 'CRM, seguimiento de leads y automatización de ventas', 'Mesas de ayuda, ticketing y experiencia del cliente', 'Digitalización, archivado y recuperación de documentos', 'Conciliación, reporting y control financiero automatizado', 'Dashboard corporativo y alineación de objetivos estratégicos'],
    ...
    legal: { back: 'Volver al inicio', privacy: 'Política de Privacidad', terms: 'Términos y Condiciones', cookies: 'Política de Cookies' },
  ...
  en: {
    ...
    areasDesc: ['Payroll, recruitment and talent management automation', 'Operational workflow optimization and real-time monitoring', 'Stock control, traceability and smart replenishment', 'Vendor management, purchase orders and budgeting', 'CRM, lead tracking and sales automation', 'Help desk, ticketing and customer experience', 'Digitization, archiving and document retrieval', 'Reconciliation, reporting and automated financial control', 'Corporate dashboard and strategic goal alignment'],
    ...
    legal: { back: 'Back to home', privacy: 'Privacy Policy', terms: 'Terms and Conditions', cookies: 'Cookie Policy' },
    consent: { aria: 'Storage preferences notice', text: 'This site uses local storage in your browser to remember your language and theme preferences. We do not use tracking cookies.', more: 'Learn more', accept: 'Accept', reject: 'Reject' },
  },
}
